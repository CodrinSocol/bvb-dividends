...
public class Dividend {
  ...
  public static Dividend fromDividendInfo(Company company, DividendInfo dividendInfo) {
    ...
    dividend.setReferenceDateForGMS(dividendInfo.getReferenceDateForGMS() != null ?
        fromXMLGregorianCalendar(dividendInfo.getReferenceDateForGMS()) : null);
    dividend.setGMSDate(
        dividendInfo.getGMSDate() != null ? fromXMLGregorianCalendar(dividendInfo.getGMSDate()) :
            null);
    dividend.setRecordDate(dividendInfo.getRecordDate() != null ?
        fromXMLGregorianCalendar(dividendInfo.getRecordDate()) : null);
    dividend.setExDividendDate(dividendInfo.getExDividendDate() != null ?
        fromXMLGregorianCalendar(dividendInfo.getExDividendDate()) : null);
    dividend.setAnnouncementDate(dividendInfo.getAnnouncementDate() != null ?
        fromXMLGregorianCalendar(dividendInfo.getAnnouncementDate()) : null);
    dividend.setStartPaymentDate(dividendInfo.getStartPaymentDate() != null ?
        fromXMLGregorianCalendar(dividendInfo.getStartPaymentDate()) : null);
    dividend.setEndPaymentDate(dividendInfo.getEndPaymentDate() != null ?
        fromXMLGregorianCalendar(dividendInfo.getEndPaymentDate()) : null);
