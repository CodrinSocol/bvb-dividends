...
public class DividendService {
  ...
  public Page<Dividend> getAllDividendsPaginated(Integer pageNumber,
    ...
    if (companySymbol == null) {
      return dividendRepository.findAllByExDividendDateAfterAndExDividendDateBefore(startDateTime,
          endDateTime, pageable);
    }

    return dividendRepository.findAllByCompanySymbolAndExDividendDateAfterAndExDividendDateBefore(
        companySymbol, startDateTime, endDateTime, pageable);
  }
